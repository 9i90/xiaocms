...
function _uCInfo() {
 ...
 if (_ulink && !_ubl) {
  ...
  if (z!="-" && z.indexOf(";")==-1) {
 _ubd.cookie="__utmz="+z+"; path="+_utcp+";"+x+_udo; return ""; 
}
 ...
 if ((t!="-" && t!="") || (t2!="-" && t2!="") || (t3!="-" && t3!="")) {
  ...
  if (t2!="-" && t2!="") {
 if (c != "") c+="|"; c+="utmcsr="+_uEC(t2); 
}
  if (t3!="-" && t3!="") {
 if (c != "") c+="|"; c+="utmgclid="+_uEC(t3); 
}
  t=_uGC(s,_uccn+"=","&");
 ...
 t=_uOrg(1); if (t!="-" && t!="") c+="|utmctr="+_uEC(t); 
}
  t=_uGC(s,_ucct+"=","&");
 ...
 if (c=="-" || c=="") {
 c=_uOrg(); if (z!="-" && _ufno==1)  return ""; 
}
 if (c=="-" || c=="") {
 if (_ufns==1)  c=_uRef(); if (z!="-" && _ufno==1)  return ""; 
}
 if (c=="-" || c=="") {
