...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="userInfoList" title="用户主信息" actionUrl="userInfoController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="password" field="password"  hidden="true"  width="120"></t:dgCol>
   <t:dgCol title="昵称" field="nickname"   width="120"></t:dgCol>
   <t:dgCol title="邀请人" field="inviteUser" dictionary="user_info,user_id,nickname"    width="120"></t:dgCol>
