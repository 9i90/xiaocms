...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="userAccountLogList" title="账户变动日志" actionUrl="userAccountLogController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="资金变动时间" field="addtime"  formatter="yyyy-MM-dd hh:mm:ss"  width="120"></t:dgCol>
