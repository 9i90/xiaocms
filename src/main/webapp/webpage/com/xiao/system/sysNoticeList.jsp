...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="sysNoticeList" title="系统公告" actionUrl="sysNoticeController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="sysNoticeController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="sysNoticeController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="sysNoticeController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>