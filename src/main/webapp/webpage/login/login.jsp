...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <!-- <div class="logo">jnzuo 金牛座管理平台<img src="plug-in/login/images/head.png" /><img src="plug-in/login/images/foot.png" /></div> -->
            <div  class="logo" style="font: bold;font-size: 30px;color: blue;" >微赚管理平台<!-- <img src="plug-in/login/images/head.png" /><img src="plug-in/login/images/foot.png" /> --></div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>jnzuo</a> <t:mutiLang langKey="common.browser.recommend"/>:<a href="#" title=<t:mutiLang langKey="common.platform"/>>jnzuo</a></span></div>
    </div>
    <!-- Link JScript-->
 ...
 <!--    <script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js"></script> -->
    ...
    <script type="text/javascript">var statType = 'PC' ;</script>
    <script type="text/javascript" src="https://stat.jnzuo.com/js/statistics.js"> </script>
