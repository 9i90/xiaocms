...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
			...
			if (oConvertUtils.isIn("smartMenu", types)) {
				sb.append("<link href=\"plug-in/smartMenu/css/smartMenu.css\" rel=\"stylesheet\" type=\"text/css\" />");
				sb.append("<script src=\"plug-in/smartMenujs/js/jquery-smartMenu.js\" type=\"text/javascript\"></script>");
			}
